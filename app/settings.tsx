...
import { ChevronRight, ChevronLeft, Bell, Users, CreditCard, CircleHelp as HelpCircle, FileText, Chrome as Home } from 'lucide-react-native';
      ...
      <View style={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.menuItem}>
            <Users size={24} color={Colors.gray400} />
